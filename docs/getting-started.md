...
- **`@discoui-org/core`**: The rendering engine and high-performance animation motor.
- **`@discoui-org/vue`**:
...
- **`@discoui-org/capacitor`**: Bridges hardware events (Back button, Haptics) directly to the UI navigation stack and lifecycle.
